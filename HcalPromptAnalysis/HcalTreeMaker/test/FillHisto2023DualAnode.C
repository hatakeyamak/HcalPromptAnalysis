...
// HE rechits too
  ...
  TH1D *h_nRecHitsHE4 = new TH1D("nRecHitsHE4","nRecHitsHE4",760,0,3800);
  TH1D *h_nRecHitsHE5 = new TH1D("nRecHitsHE5","nRecHitsHE5",760,0,3800);
  TH1D *h_nRecHitsHE6 = new TH1D("nRecHitsHE6","nRecHitsHE6",760,0,3800);
  TH1D *h_nRecHitsHE7 = new TH1D("nRecHitsHE7","nRecHitsHE7",760,0,3800);
  TH1D *h_nRecHitsHE8 = new TH1D("nRecHitsHE8","nRecHitsHE8",760,0,3800);
  ...
  TH1D *h_nRecHitsHE4s = new TH1D("nRecHitsHE4s","nRecHitsHE4s",760,0,3800);
  TH1D *h_nRecHitsHE5s = new TH1D("nRecHitsHE5s","nRecHitsHE5s",760,0,3800);
  TH1D *h_nRecHitsHE6s = new TH1D("nRecHitsHE6s","nRecHitsHE6s",760,0,3800);
  TH1D *h_nRecHitsHE7s = new TH1D("nRecHitsHE7s","nRecHitsHE7s",760,0,3800);
  TH1D *h_nRecHitsHE8s = new TH1D("nRecHitsHE8s","nRecHitsHE8s",760,0,3800);
  ...
  TH1D *energyHE4 = new TH1D("energyHE4","energyHE4",110,-20,200);
  TH1D *energyHE5 = new TH1D("energyHE5","energyHE5",110,-20,200);
  TH1D *energyHE6 = new TH1D("energyHE6","energyHE6",110,-20,200);
  TH1D *energyHE7 = new TH1D("energyHE7","energyHE7",110,-20,200);
  TH1D *energyHE8 = new TH1D("energyHE8","energyHE8",110,-20,200);
  ...
  TH1D *energyHE4s = new TH1D("energyHE4s","energyHE4s",110,-20,200);
  TH1D *energyHE5s = new TH1D("energyHE5s","energyHE5s",110,-20,200);
  TH1D *energyHE6s = new TH1D("energyHE6s","energyHE6s",110,-20,200);
  TH1D *energyHE7s = new TH1D("energyHE7s","energyHE7s",110,-20,200);
  TH1D *energyHE8s = new TH1D("energyHE8s","energyHE8s",110,-20,200);
  ...
  TH1D *recHitTimingHE4 = new TH1D("recHitTimingHE4","recHitTimingHE4",70,-48,92);
  TH1D *recHitTimingHE5 = new TH1D("recHitTimingHE5","recHitTimingHE5",70,-48,92);
  TH1D *recHitTimingHE6 = new TH1D("recHitTimingHE6","recHitTimingHE6",70,-48,92);
  TH1D *recHitTimingHE7 = new TH1D("recHitTimingHE7","recHitTimingHE7",70,-48,92);
  TH1D *recHitTimingHE8 = new TH1D("recHitTimingHE8","recHitTimingHE8",70,-48,92);
  ...
  TH1D *recHitTimingHE4s = new TH1D("recHitTimingHE4s","recHitTimingHE4s",70,-48,92);
  TH1D *recHitTimingHE5s = new TH1D("recHitTimingHE5s","recHitTimingHE5s",70,-48,92);
  TH1D *recHitTimingHE6s = new TH1D("recHitTimingHE6s","recHitTimingHE6s",70,-48,92);
  TH1D *recHitTimingHE7s = new TH1D("recHitTimingHE7s","recHitTimingHE7s",70,-48,92);
  TH1D *recHitTimingHE8s = new TH1D("recHitTimingHE8s","recHitTimingHE8s",70,-48,92);
  ...
  TH2D *recHitOccupancyHE4 = new TH2D("recHitOccupancyHE4","recHitOccupancyHE4",83,-41.5,41.5,73,-0.5,72.5);
  TH2D *recHitOccupancyHE5 = new TH2D("recHitOccupancyHE5","recHitOccupancyHE5",83,-41.5,41.5,73,-0.5,72.5);
  TH2D *recHitOccupancyHE6 = new TH2D("recHitOccupancyHE6","recHitOccupancyHE6",83,-41.5,41.5,73,-0.5,72.5);
  TH2D *recHitOccupancyHE7 = new TH2D("recHitOccupancyHE7","recHitOccupancyHE7",83,-41.5,41.5,73,-0.5,72.5);
  TH2D *recHitOccupancyHE8 = new TH2D("recHitOccupancyHE8","recHitOccupancyHE8",83,-41.5,41.5,73,-0.5,72.5);
  ...
  TProfile2D *recHitTimingMapHE4 = new TProfile2D("recHitTimingMapHE4","recHitTimingMapHE4",83, -41.5,41.5,73,-0.5,72.5);
  TProfile2D *recHitTimingMapHE5 = new TProfile2D("recHitTimingMapHE5","recHitTimingMapHE5",83, -41.5,41.5,73,-0.5,72.5);
  TProfile2D *recHitTimingMapHE6 = new TProfile2D("recHitTimingMapHE6","recHitTimingMapHE6",83, -41.5,41.5,73,-0.5,72.5);
  TProfile2D *recHitTimingMapHE7 = new TProfile2D("recHitTimingMapHE7","recHitTimingMapHE7",83, -41.5,41.5,73,-0.5,72.5);
  TProfile2D *recHitTimingMapHE8 = new TProfile2D("recHitTimingMapHE8","recHitTimingMapHE8",83, -41.5,41.5,73,-0.5,72.5);
  ...
  TProfile2D *energyMapHE4 = new TProfile2D("energyMapHE4","energyMapHE4",83, -41.5,41.5,73,-0.5,72.5);
  TProfile2D *energyMapHE5 = new TProfile2D("energyMapHE5","energyMapHE5",83, -41.5,41.5,73,-0.5,72.5);
  TProfile2D *energyMapHE6 = new TProfile2D("energyMapHE6","energyMapHE6",83, -41.5,41.5,73,-0.5,72.5);
  TProfile2D *energyMapHE7 = new TProfile2D("energyMapHE7","energyMapHE7",83, -41.5,41.5,73,-0.5,72.5);
  TProfile2D *energyMapHE8 = new TProfile2D("energyMapHE8","energyMapHE8",83, -41.5,41.5,73,-0.5,72.5);
  ...
  while(tReader->Next()){
    ...
    for(int ridx = 0; ridx < (*readRecHitsHE_En).size(); ridx++){
      ...
      energyHE->Fill(energy);
      energyHEs->Fill(energy);
      if(energy > 0.7){
         energyCutHE->Fill(energy);
	 energyCutHEs->Fill(energy);
      }
      ...
      if(depth == 1){
         energyHE1->Fill(energy);
         energyHE1s->Fill(energy);

         recHitTimingHE1->Fill(time);
         recHitTimingHE1s->Fill(time);

         recHitOccupancyHE1->Fill(ieta,iphi);
         recHitTimingMapHE1->Fill(ieta,iphi,time);
         energyMapHE1->Fill(ieta,iphi,energy);
      ...
      if(depth == 2){
         energyHE2->Fill(energy);
         energyHE2s->Fill(energy);

         recHitTimingHE2->Fill(time);
         recHitTimingHE2s->Fill(time);

         recHitOccupancyHE2->Fill(ieta,iphi);
         recHitTimingMapHE2->Fill(ieta,iphi,time);
         energyMapHE2->Fill(ieta,iphi,energy);
      ...
      if(depth == 3){
         energyHE3->Fill(energy);
         energyHE3s->Fill(energy);

         recHitTimingHE3->Fill(time);
         recHitTimingHE3s->Fill(time);

         recHitOccupancyHE3->Fill(ieta,iphi);
         recHitTimingMapHE3->Fill(ieta,iphi,time);
         energyMapHE3->Fill(ieta,iphi,energy);
      ...
      if(depth == 4){
         energyHE4->Fill(energy);
         energyHE4s->Fill(energy);

         recHitTimingHE4->Fill(time);
         recHitTimingHE4s->Fill(time);

         recHitOccupancyHE4->Fill(ieta,iphi);
         recHitTimingMapHE4->Fill(ieta,iphi,time);
         energyMapHE4->Fill(ieta,iphi,energy);
         ...
         nRecHitsHE4 = nRecHitsHE4 + 1;
      }

      if(depth == 5){
         energyHE5->Fill(energy);
         energyHE5s->Fill(energy);

         recHitTimingHE5->Fill(time);
         recHitTimingHE5s->Fill(time);

         recHitOccupancyHE5->Fill(ieta,iphi);
         recHitTimingMapHE5->Fill(ieta,iphi,time);
         energyMapHE5->Fill(ieta,iphi,energy);
         ...
         nRecHitsHE5 = nRecHitsHE5 + 1;
      }

      if(depth == 6){
         energyHE6->Fill(energy);
         energyHE6s->Fill(energy);

         recHitTimingHE6->Fill(time);
         recHitTimingHE6s->Fill(time);

         recHitOccupancyHE6->Fill(ieta,iphi);
         recHitTimingMapHE6->Fill(ieta,iphi,time);
         energyMapHE6->Fill(ieta,iphi,energy);
         ...
         nRecHitsHE6 = nRecHitsHE6 + 1;
      }

      if(depth == 7){
         energyHE7->Fill(energy);
         energyHE7s->Fill(energy);

         recHitTimingHE7->Fill(time);
         recHitTimingHE7s->Fill(time);

         recHitOccupancyHE7->Fill(ieta,iphi);
         recHitTimingMapHE7->Fill(ieta,iphi,time);
         energyMapHE7->Fill(ieta,iphi,energy);
         ...
         nRecHitsHE7 = nRecHitsHE7 + 1;
      }

      if(depth == 8){
         energyHE8->Fill(energy);
         energyHE8s->Fill(energy);

         recHitTimingHE8->Fill(time);
         recHitTimingHE8s->Fill(time);

         recHitOccupancyHE8->Fill(ieta,iphi);
         recHitTimingMapHE8->Fill(ieta,iphi,time);
         energyMapHE8->Fill(ieta,iphi,energy);
	...
	if(energy > 0.7){
     ...
     h_nRecHitsHE4->Fill(nRecHitsHE4);
     h_nRecHitsHE4s->Fill(nRecHitsHE4);
     h_nRecHitsHE5->Fill(nRecHitsHE5);
     h_nRecHitsHE5s->Fill(nRecHitsHE5);
     h_nRecHitsHE6->Fill(nRecHitsHE6);
     h_nRecHitsHE6s->Fill(nRecHitsHE6);
     h_nRecHitsHE7->Fill(nRecHitsHE7);
     h_nRecHitsHE7s->Fill(nRecHitsHE7);
     h_nRecHitsHE8->Fill(nRecHitsHE8);
     h_nRecHitsHE8s->Fill(nRecHitsHE8);
  ...
  energyHE4s->Scale(1/(float)nEvents);
  energyHE5s->Scale(1/(float)nEvents);
  energyHE6s->Scale(1/(float)nEvents);
  energyHE7s->Scale(1/(float)nEvents);
  energyHE8s->Scale(1/(float)nEvents);
  ...
  recHitTimingHE4s->Scale(1/(float)nEvents);
  recHitTimingHE5s->Scale(1/(float)nEvents);
  recHitTimingHE6s->Scale(1/(float)nEvents);
  recHitTimingHE7s->Scale(1/(float)nEvents);
  recHitTimingHE8s->Scale(1/(float)nEvents);
  ...
  h_nRecHitsHE4s->Scale(1/(float)nEvents);
  h_nRecHitsHE5s->Scale(1/(float)nEvents);
  h_nRecHitsHE6s->Scale(1/(float)nEvents);
  h_nRecHitsHE7s->Scale(1/(float)nEvents);
  h_nRecHitsHE8s->Scale(1/(float)nEvents);
