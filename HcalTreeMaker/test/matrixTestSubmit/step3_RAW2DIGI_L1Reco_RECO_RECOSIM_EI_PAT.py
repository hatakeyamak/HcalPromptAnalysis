...
# with command line options: step3 --conditions auto:phase1_2019_realistic -n 10 --era Run3 --eventcontent RECOSIM,MINIAODSIM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT --datatier GEN-SIM-RECO,MINIAODSIM --geometry Extended2019 --filein file:step2.root --fileout file:step3.root
