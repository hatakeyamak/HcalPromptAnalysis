...
# with command line options: SinglePiE50HCAL_pythia8_cfi --conditions auto:phase1_2019_realistic -n 10 --era Run3 --eventcontent FEVTDEBUG --relval 50000,500 -s GEN,SIM --datatier GEN-SIM --beamspot Realistic25ns13TeVEarly2017Collision --geometry Extended2019 --fileout file:step1.root
...
#        ParticleID = cms.vint32(211)
    ...
    psethack = cms.string('single K0L')
)
