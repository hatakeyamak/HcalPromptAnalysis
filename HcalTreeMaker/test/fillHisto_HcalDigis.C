...
void fillHisto_HcalDigis(const char *infile, const char *outfile, const char *flag = "single"){
  ...
  while(tReader->Next()){
    ...
    double min_totcharge_SiPM = 5000; //5000fC (~2GeV)
    double min_totcharge_HPD  = 50;  //Not Sure where to put this 
    ...
    for(int digi = 0; digi < (*DigiHBHE_charge0).size(); digi++){
      ...
      totsumHBHE = sumHBHE0 + sumHBHE1 + sumHBHE2 + sumHBHE3 + sumHBHE4 + sumHBHE5 + sumHBHE6 + sumHBHE7 + sumHBHE8 + sumHBHE9;
    ...
    for(int digi = 0; digi < (*DigiHBHE_QIE11_charge0).size(); digi++){
      ...
      totsumHBHE_QIE11 = sumHBHE_QIE110 + sumHBHE_QIE111 + sumHBHE_QIE112 + sumHBHE_QIE113 + sumHBHE_QIE114 + sumHBHE_QIE115 + sumHBHE_QIE116 + sumHBHE_QIE117 + sumHBHE_QIE118 + sumHBHE_QIE119;
    ...
    for(int digi = 0; digi < (*DigiHO_charge0).size(); digi++){
      ...
      totsumHO = sumHO0 + sumHO1 + sumHO2 + sumHO3 + sumHO4 + sumHO5 + sumHO6 + sumHO7 + sumHO8 + sumHO9;
    ...
    for(int digi = 0; digi < (*DigiHF_QIE10_charge0).size(); digi++){
      ...
      totsumHF_QIE10 = sumHF_QIE100 + sumHF_QIE101 + sumHF_QIE102 + sumHF_QIE103 + sumHF_QIE104 + sumHF_QIE105 + sumHF_QIE106 + sumHF_QIE107 + sumHF_QIE108 + sumHF_QIE109;

      ///Total charge must be greater than 5000 fC
      if(totsumHF_QIE10 > min_totcharge_HPD){
