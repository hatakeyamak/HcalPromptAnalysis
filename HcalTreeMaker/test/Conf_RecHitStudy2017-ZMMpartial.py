...
process = cms.Process("RecHitsSpectraGen",eras.Run2_2017)
...
mylist = FileUtils.loadListFromFile ('dataset2017-partial.txt')
...
process.hcalRecHitSpectra2023.rootOutputFile            = cms.string('HcalRecHitSpectra2017-ZMMpartial.root')
process.hcalRecHitSpectra2023.HBHERecHitCollectionLabel = cms.untracked.InputTag("hbhereco")
process.hcalRecHitSpectra2023.HFRecHitCollectionLabel   = cms.untracked.InputTag("hfreco")
