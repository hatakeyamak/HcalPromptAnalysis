...
void TMVARegression_PF( TString myMethodList = "" )
{
   ...
   Use["PDERS"]           = 0;
   Use["PDEFoam"]         = 0; // KH turned it off
   Use["KNN"]             = 0; // KH turned it off
   //
   ...
   TString outfileName( "TMVAReg_PF.root" );
   ...
   dataloader->AddVariable( "pf_pt", "Variable 1", "units", 'F' );
   dataloader->AddVariable( "pf_eta", "Variable 1b", "units", 'F' );
   dataloader->AddVariable( "pf_ecalFrac", "Variable 2", "units", 'F' );
   dataloader->AddVariable( "pf_hcalFrac", "Variable 3", "units", 'F' );
   /*
   dataloader->AddVariable( "pf_hcalFrac1", "Variable 4", "units", 'F' );
   dataloader->AddVariable( "pf_hcalFrac2", "Variable 5", "units", 'F' );
   dataloader->AddVariable( "pf_hcalFrac3", "Variable 6", "units", 'F' );
   dataloader->AddVariable( "pf_hcalFrac4", "Variable 7", "units", 'F' );
   dataloader->AddVariable( "pf_hcalFrac5", "Variable 8", "units", 'F' );
   dataloader->AddVariable( "pf_hcalFrac6", "Variable 9", "units", 'F' );
   dataloader->AddVariable( "pf_hcalFrac7", "Variable 10", "units", 'F' );
   */
   ...
   //dataloader->AddSpectator( "gen_pt",  "Spectator 1", "units", 'F' );
   dataloader->AddSpectator( "gen_eta", "Spectator 1b", "units", 'F' );
   dataloader->AddSpectator( "gen_phi", "Spectator 2", "units", 'F' );
   //dataloader->AddSpectator( "pf_pt",   "Spectator 3", "units", 'F' );
   dataloader->AddSpectator( "pf_eta",  "Spectator 3b", "units", 'F' );
   dataloader->AddSpectator( "pf_phi",  "Spectator 4", "units", 'F' );
   // Add the variable carrying the regression target
   dataloader->AddTarget( "gen_pt" );
   ...
   TFile *input(0);
   TString fname = "./pfstudy_histograms_K0S.root";
   ...
   dataloader->SetWeightExpression( "pf_pt", "Regression" );
   // Apply additional cuts on the signal and background samples (can be different)
   //TCut mycut = "fabs(gen_eta)>1.5&&fabs(gen_eta)<2.0&&(gen_pt+pf_pt)/2.>10."; // for example: TCut mycut = "abs(var1)<0.5 && abs(var2-0.5)<1";
